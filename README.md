LibreMobileOS Statistics Backend
=======================
...
* Device model, taken from `ro.lmodroid.device`.
* Device version, taken from `ro.lmodroid.build_name`. For LMODroid builds, this is in the format `VERSION-DATE-TYPE-MODEL`.
